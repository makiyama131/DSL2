                                ...
                                <div class="bg-gray-50 dark:bg-gray-700/50 shadow-md rounded-lg p-4 hover:shadow-xl transition-shadow duration-200 ease-in-out"
                                    ...
                                    <div class="mt-3 border-t border-gray-200 dark:border-gray-600 pt-3">
                                        ...
                                        <div class="sm:col-span-1 mt-2">
                                            <dt class="text-gray-500 dark:text-gray-400 font-medium">{{ __('住所') }}</dt>
                                            <dd class="text-gray-800 dark:text-gray-200">
                                                {{ $callList->address ?? '-' }}
                                            </dd>
                                        </div>
                                        {{-- ★★★ URLボタン（存在する場合のみ表示） ★★★ --}}
                                        <div class="flex items-center justify-end flex-wrap gap-2 flex-grow">

                                            @if($callList->url_website)
                                            <a href="{{ $callList->url_website }}" target="_blank" rel="noopener noreferrer"
                                                class="inline-block px-2.5 py-1 text-xs font-semibold text-white bg-gray-600 rounded-full hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                                                aria-label="ウェブサイト">
                                                Webサイト
                                            </a>
                                            @endif

                                            @if($callList->recruitment_site_url)
                                            <a href="{{ $callList->recruitment_site_url }}" target="_blank" rel="noopener noreferrer"
                                                class="inline-block px-2.5 py-1 text-xs font-semibold text-white bg-green-600 rounded-full hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                                                aria-label="求人サイト">
                                                求人
                                            </a>
                                            @endif

                                            @if($callList->url_instagram)
                                            <a href="{{ $callList->url_instagram }}" target="_blank" rel="noopener noreferrer"
                                                class="inline-block px-2.5 py-1 text-xs font-semibold text-white bg-pink-600 rounded-full hover:bg-pink-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                                                aria-label="Instagram">
                                                Instagram
                                            </a>
                                            @endif

                                            @if($callList->url_facebook)
                                            <a href="{{ $callList->url_facebook }}" target="_blank" rel="noopener noreferrer"
                                                class="inline-block px-2.5 py-1 text-xs font-semibold text-white bg-blue-800 rounded-full hover:bg-blue-900 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700"
                                                aria-label="Facebook">
                                                Facebook
                                            </a>
                                            @endif

                                            @if($callList->url_twitter)
                                            <a href="{{ $callList->url_twitter }}" target="_blank" rel="noopener noreferrer"
                                                class="inline-block px-2.5 py-1 text-xs font-semibold text-white bg-sky-500 rounded-full hover:bg-sky-600 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-400"
                                                aria-label="Twitter">
                                                Twitter
                                            </a>
                                            @endif

                                            @if($callList->url_tiktok)
                                            <a href="{{ $callList->url_tiktok }}" target="_blank" rel="noopener noreferrer"
                                                class="inline-block px-2.5 py-1 text-xs font-semibold text-white bg-black rounded-full hover:bg-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                                                aria-label="TikTok">
                                                TikTok
                                            </a>
                                            @endif

                                            @if($callList->url_youtube)
                                            <a href="{{ $callList->url_youtube }}" target="_blank" rel="noopener noreferrer"
                                                class="inline-block px-2.5 py-1 text-xs font-semibold text-white bg-red-600 rounded-full hover:bg-red-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                                aria-label="YouTube">
                                                YouTube
                                            </a>
                                            @endif

                                            @if($callList->url_other_sns)
                                            <a href="{{ $callList->url_other_sns }}" target="_blank" rel="noopener noreferrer"
                                                class="inline-block px-2.5 py-1 text-xs font-semibold text-gray-800 bg-gray-200 rounded-full hover:bg-gray-300 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
                                                aria-label="その他SNS">
                                                その他
                                            </a>
                                            @endif
