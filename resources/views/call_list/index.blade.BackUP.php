                        ...
                        <form method="GET" action="{{ route('call-list.index') }}" x-ref="callListFilterForm"
                            ...
                            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 items-end">
                                <div>
                                    ...
                                    <select name="sort_by" id="sort_by_select" class="mt-1 block w-full rounded-md ..."
                                ...
                                @foreach ($callLists as $callList)
                                                    <div class="bg-gray-50 dark:bg-gray-700/50 shadow-md rounded-lg p-4 hover:shadow-xl transition-shadow duration-200 ease-in-out"
                                                        ...
                                                        <div class="flex flex-col sm:flex-row justify-between items-start">
                                                            ...
                                                            <div class="text-sm font-medium call-status-cell px-3 py-1 rounded-full whitespace-nowrap min-w-[100px] text-center {{
                                    match ($callList->latestCallStatus->status_name ?? '') {
                                        ...
                                        default => 'bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-200',
                                                        ...
                                                        <div
                                                            ...
                                                            <form action="{{ route('call-list.destroy', $callList) }}" method="POST"
                                                                class="inline w-full sm:w-auto flex-grow sm:flex-grow-0"
                                                                onsubmit="return confirm('本当に「{{ addslashes(e($callList->company_name)) }}」を削除してもよろしいですか？');">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
                                                                    class="w-full items-center justify-center text-center px-5 py-2.5 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900 transition-transform transform hover:scale-105">
                                                                    {{ __('削除') }}
                                                                </button>
                                                            </form>
                                                        </div>
